...
export default function ProductsPage() {
    ...
    return (
        <div className="page-content" style={{ direction: 'rtl', minHeight: '100vh' }}>
            ...
            <h1 className="page-title" style={{ marginBottom: 20 }}>📦 إدارة المنتجات</h1>
            ...
            <div className="card" style={{ padding: '12px 16px', display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16, flexWrap: 'wrap' }}>
                ...
                <a href="/api/export/products/excel" className="btn btn-success" style={{ background: '#059669', textDecoration: 'none' }}>📥 تصدير</a>
